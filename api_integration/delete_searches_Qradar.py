...
def delete_searches_Qradar(Qradar_address=Qradar_address_default, search_id=search_id_default,
    ...
    try:
        ...
        delete_request_ariel_searches = requests.delete(
        ...
        logging_utils.run_log("ERROR", f"QRadar delete_search timeout after {timeout}s: {e}")
        return None
    except Exception as e:
        logging_utils.run_log("ERROR", f"failed to send DELETE Request to Qradar: {e}")
        return None

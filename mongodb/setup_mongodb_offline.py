...
This setup ensures zero training-serving skew by using identical rule baseline (287 rules) across all environments.
"""
    ...
    def create_config_file(self):
        ...
        config = {
            ...
            "rule_mapping": {
                ...
                "rule_ids": rule_ids,
                "source": "Production_baseline",
                "description": "Fixed 287 production rules as baseline for consistent feature vectors across environments",
                "fixed_count": True,
                "uat_mapping": {
                    "enabled": True,
                    "mapping_file": "shared_utils/uat_to_prod_mapping.csv",

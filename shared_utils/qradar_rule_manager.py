...
class QRadarRuleManager:
    ...
    def __init__(self, mode: str = 'api', config: Dict = None):
        """
...
def get_rule_list(mode: str = 'file', config: Dict = None) -> List[int]:
    """
    ...
    Returns:
        List of rule IDs
    """
    manager = QRadarRuleManager(mode=mode, config=config)
    return manager.get_rule_list()


def get_rule_to_index_map(mode: str = 'file', config: Dict = None) -> Dict[int, int]:
    """
...
if __name__ == "__main__":
    ...
    # Create manager
    manager = QRadarRuleManager(mode=args.mode)
